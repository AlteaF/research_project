...
for C in [0.01, 0.1, 1, 10, 20, 50, 100]:
    svm = SVC(C=C, random_state=42, class_weight="balanced", kernel= "poly", degree=2)
...
# === Save final model ===
joblib.dump(best_model, "SVC_poly_2_dinov2.joblib")
print(f"\nSaved best model (C={best_C}) to 'svc_poly_2_dinov2.joblib'")
